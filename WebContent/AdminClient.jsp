...
<body>
<h1>Clients Modification</h1>
<form action="EnregistrementClient" method="post">
<table>
...
if (cliList.size()!=0)
	{	
		...
		{	
			...
			<td><input type="text" name="client_nom" value="<%= element.getNom() %>"/></td>
			<td><input type="text" name="client_prenom" value="<%= element.getPrenom() %>"/></td>
			<td><input type="text" name="client_adresse" value="<%= element.getAdresse() %>"/></td>
			<td><input type="text" name="client_ville" value="<%= element.getVille() %>"/></td>
			<td><input type="text" name="client_cp" value="<%= element.getCodePostal() %>"/></td>
			<td><input type="submit" Value="Modifier Client" /></td>
